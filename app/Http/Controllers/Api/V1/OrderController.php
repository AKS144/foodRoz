...
class OrderController extends Controller
{
    ...
    public function place_order(Request $request)
    {
        ...
        foreach ($request['cart'] as $c) {
            if ($c['item_campaign_id'] != null) {
                ...
                if ($product) {
                    if (count(json_decode($product['variations_sell'], true)) > 0) {
        ...
        try {
            ...
            //echo $order->restaurant->vendor->phone;die;
            $order->save();
            ...
            SMS_module::msg_91_var($order->customer->phone,"6296df1e973f245c654722a2",$order->id);
            SMS_module::msg_91_var($order->restaurant->vendor->phone,"6296dee6aca26c5d8615f472",$order->id);
            SMS_module::msg_91_var2("+918056380328","62dd9428010649391f421188","Admin",$order->id);
            //$order_mail = new OrderPlaced($order->id);
            //Mail::to($order->customer->email)->send($order_mail);
    ...
    public function cancel_order(Request $request)
    {
        ...
        if(!$order){
            ...
            SMS_module::msg_91_var($order->restaurant->vendor->phone,"6296de75ff92d6222330fe22",$order->id);
