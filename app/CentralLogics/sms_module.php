...
class SMS_module
{
    ...
    public static function msg_91_var($receiver,$flow_id, $order_id)
    {
        $config = self::get_settings('msg91_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                CURLOPT_CUSTOMREQUEST => "GET",
                CURLOPT_POSTFIELDS => "{\"flow_id\": \"$flow_id\",\"sender\": \"FOODRZ\",\"recipients\": [{\"mobiles\": \"$receiver\",\"order_id\": \"$order_id\"}]}",
                CURLOPT_HTTPHEADER => array(
    ...
    public static function msg_91_var2($receiver,$flow_id,$mobile,$order_id)
    {
        $config = self::get_settings('msg91_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                CURLOPT_CUSTOMREQUEST => "GET",
                CURLOPT_POSTFIELDS => "{\"flow_id\": \"$flow_id\",\"sender\": \"FOODRZ\",\"recipients\": [{\"mobiles\": \"$receiver\",\"mobile\": \"$mobile\",\"order_id\": \"$order_id\"}]}",
                CURLOPT_HTTPHEADER => array(
                    "authkey: ".$config['authkey']."",
                    "content-type: application/json"
                ),
    ...
    public static function msg_91_sms($receiver,$flow_id)
    {
        $config = self::get_settings('msg91_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                CURLOPT_CUSTOMREQUEST => "GET",
                CURLOPT_POSTFIELDS => "{\"flow_id\": \"$flow_id\",\"sender\": \"FOODRZ\",\"recipients\": [{\"mobiles\": \"$receiver\"}]}",
                CURLOPT_HTTPHEADER => array(
                    "authkey: ".$config['authkey']."",
                    "content-type: application/json"
                ),
