        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="card-header-title"> {{__('messages.addon')}} {{__('messages.list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$addons->total()}}</span></h1>
                </div>
                @if(isset($addon))
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-sm-auto" style="width: 306px;">
                            <select name="restaurant_id" onchange="set_restaurant_filter('{{route('admin.addon.add-new')}}',this.value)" data-placeholder="{{__('messages.select')}} {{__('messages.restaurant')}}" class="js-data-example-ajax form-control"   title="Select Restaurant">
                            @if(isset($restaurant))    
