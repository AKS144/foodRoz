                        ...
                        @if($detail->food )
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    @php($restaurant_price=round($detail['price']*100/(100+$comission),2))
                                    ...
                                    <div class="row">
                                            ...
                                            @if(count(json_decode($detail['variation'],true))>0)
                                                ...
                                                @foreach(json_decode($detail['variation'],true)[0] as $key1 =>$variation)
                                                    <div class="font-size-sm text-body">
                                                        <span>{{$key1}} :  </span>
                                                        @if($key1 == "price")
                                                        <span class="font-weight-bold">{{$restaurant_price}}</span>
                                                        @else
                                        ...
                                        <div class="col col-md-2 align-self-center">
                                            ...
                                            <h6>
                                            {{\App\CentralLogics\Helpers::format_currency($restaurant_price)}}</h6>
                                        </div>
                                        ...
                                        <div class="col col-md-3 align-self-center text-right">
                                            @php($amount=($restaurant_price)*$detail['quantity'])
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6">{{\App\CentralLogics\Helpers::format_currency($product_price+$total_addon_price - $restaurant_discount_amount)}}</dd>
                                </dl>
                                <!-- End Row -->
                            </div>
                        </div>
