                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="available_time_starts" class="form-control" value="{{$opening_time}}" min="{{$opening_time}}"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="available_time_ends" class="form-control" value="{{$closing_time}}" max="{{$closing_time}}"  placeholder="5:45 pm"
                                       required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{__('messages.preparation_time')}}</label>
                        <input type="text" name="preparation_time" id="preparation_time" class="form-control ckeditor"></input>
                    </div>
