...
<head>
    ...
    <meta name="Description" content="@if(isset($landing_page_text['seo_description'])) {!! $landing_page_text['seo_description'] !!} @endif">

    <meta name="Keywords" content="@if(isset($landing_page_text['seo_keywords'])) {!! $landing_page_text['seo_keywords'] !!} @endif">
     @php($logo=\App\CentralLogics\Helpers::get_settings('logo'))
    <meta property="og:title" content="{!! $landing_page_text['header_title_1'] !!}">
                 <meta property="og:description" content="@if(isset($landing_page_text['seo_description'])) {!! $landing_page_text['seo_description'] !!} @endif">
                 <meta property="og:type" content="article">
                 <meta property="og:url" content="https://foodroz.com">
                 <meta property="og:image" content="{{asset('storage/app/public/business/'.$logo)}}">
   

   <!-- Fav Icon -->

    <link rel="shortcut icon" href="{{asset('storage/app/public/business/')}}/favicon.ico">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-222341910-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-222341910-1');
    </script>
            ...
            <div class="container">
                <a class="navbar-brand" href="{{route('home')}}">
                    ...
                    <img  onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                          ...
                          style="height:auto;width:100%; max-width:100px; max-height:100px;">
                </a>
